 ...
 */
class theme_kent_core_renderer_base extends core_renderer
{
    use theme_kent_bootstrap_notifications;

    protected static $tabdepth = 0;
    protected static $inusermenu = false;
    protected static $blockperfdata = array();
